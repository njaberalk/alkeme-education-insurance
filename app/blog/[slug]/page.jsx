...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/education/blog/${post.slug}/`,
    },
    openGraph: {
      title: `${post.metaTitle} | ALKEME Insurance Services`,
      description: post.metaDescription,
      url: `https://alkemeins.com/education/blog/${post.slug}/`,
      type: 'article',
    },
  };
}
  ...
  const jsonLd = [
    {
      ...
      description: post.metaDescription,
      url: `https://alkemeins.com/education/blog/${post.slug}/`,
      mainEntityOfPage: `https://alkemeins.com/education/blog/${post.slug}/`,
    },
    ...(post.faqs?.length ? [{
      '@context': 'https://schema.org',
      '@type': 'FAQPage',
