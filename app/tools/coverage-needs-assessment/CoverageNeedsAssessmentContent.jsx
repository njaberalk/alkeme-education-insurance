...
export default function CoverageNeedsAssessmentContent() {
      ...
      <section className="relative overflow-hidden bg-brand" style={{ paddingTop: '10rem', paddingBottom: '4rem' }}>
        ...
        <div className="relative max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4 text-center">
          ...
          <p className="text-cream font-light mx-auto" style={{ fontSize: '1.1rem', lineHeight: '1.6', maxWidth: '600px' }}>
            Select your institution type below to see the recommended insurance coverages, minimum limits, and compliance requirements for your educational organization.
          </p>
        </div>
      </section>
          ...
          {result && (
            <div className="max-w-3xl mx-auto">
              ...
              <div className="border-2 border-ash rounded-[2rem] p-8 mb-6 bg-white/40">
                ...
                {/* Compliance Filings */}
                <div className="mb-6">
                  <h3 className="text-brand font-bold mb-3" style={{ fontSize: '1rem' }}>Compliance & Filing Requirements</h3>
                ...
                <h3 className="text-brand font-bold mb-4" style={{ fontSize: '1rem' }}>Recommended Coverage Program</h3>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <Link href="/resources/school-insurance-cost-guide/" className="block border-2 border-ash rounded-[2rem] p-5 hover:border-blue-dark no-underline" style={{ transition: 'all 0.24s' }}>
                  <span className="text-blue-dark uppercase tracking-[0.12em] font-bold block mb-1" style={{ fontSize: '0.65rem' }}>Guide</span>
                  <span className="text-brand font-bold block" style={{ fontSize: '0.9rem' }}>How Much Does School Insurance Cost? &rarr;</span>
                </Link>
                <Link href="/resources/school-liability-guide/" className="block border-2 border-ash rounded-[2rem] p-5 hover:border-blue-dark no-underline" style={{ transition: 'all 0.24s' }}>
                  <span className="text-blue-dark uppercase tracking-[0.12em] font-bold block mb-1" style={{ fontSize: '0.65rem' }}>Guide</span>
                  <span className="text-brand font-bold block" style={{ fontSize: '0.9rem' }}>School Liability Insurance Guide &rarr;</span>
                </Link>
              </div>
            </div>
          )}
