...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/education/states/${state.slug}/`,
    },
    openGraph: {
      title: `${state.metaTitle} | ALKEME Insurance Services`,
      description: state.metaDescription,
      url: `https://alkemeins.com/education/states/${state.slug}/`,
      type: 'website',
    },
  };
}
...
export default async function StatePage({ params }) {
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: `Education Insurance in ${state.name}`,
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', '@id': `https://alkemeins.com/education/states/${state.slug}/`, name: 'ALKEME Insurance Services', url: 'https://alkemeins.com', telephone: '+18559255363', email: 'info@alkemeins.com', areaServed: { '@type': 'State', name: state.name }, priceRange: '$$' }) }} />
