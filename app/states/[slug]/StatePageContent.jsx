  ...
  return (
    <div ref={ref} className="bg-stone fade-in-view" style={{ padding: '4rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-6" style={{ fontSize: '1.5rem' }}>Education Insurance in Nearby States</h2>
    ...
    <div ref={ref} className="bg-brand fade-in-view" style={{ padding: '4rem 0' }}>
      <div className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-gold font-bold uppercase tracking-[0.12em] mb-4" style={{ fontSize: '0.8rem' }}>Institutions We Serve</h3>
            <div className="space-y-2">
              {['k12-school-districts', 'charter-schools', 'private-schools', 'colleges-universities', 'preschools-daycares'].map(slug => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { slug: 'school-insurance-cost-guide', label: 'How Much Does School Insurance Cost?' },
                { slug: 'school-liability-guide', label: 'School Liability Guide' },
                { slug: 'abuse-molestation-coverage-guide', label: 'Abuse Coverage Guide' },
                { slug: 'title-ix-compliance-guide', label: 'Title IX Compliance' },
              ].map(r => (
        ...
        <section className="bg-stone" style={{ padding: '5rem 0' }}>
          <div className="max-w-[900px] mx-auto px-[60px] max-lg:px-6 max-md:px-4">
            <h2 className="text-brand font-bold leading-[1.3] tracking-tight mb-8 text-center" style={{ fontSize: 'clamp(1.8rem, 3vw, 2.2rem)' }}>
              Education Insurance FAQ — {state.name}
            </h2>
