...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/education/industries/${industry.slug}/`,
    },
    openGraph: {
      title: industry.metaTitle,
      description: industry.metaDescription,
      url: `https://alkemeins.com/education/industries/${industry.slug}/`,
      type: 'website',
    },
  };
}
...
export default async function IndustryPage({ params }) {
  ...
  const jsonLd = {
    ...
    provider: { '@type': 'InsuranceAgency', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com/education' },
    description: industry.metaDescription,
    url: `https://alkemeins.com/education/industries/${industry.slug}/`,
