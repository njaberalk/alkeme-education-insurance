...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alkemeins.com/education/cities/${city.slug}/`,
    },
    openGraph: {
      title: `${city.metaTitle} | ALKEME Insurance Services`,
      description: city.metaDescription,
      url: `https://alkemeins.com/education/cities/${city.slug}/`,
      type: 'website',
    },
  };
}
...
export default async function CityPage({ params }) {
  ...
  const jsonLd = [
    {
      ...
      '@type': 'Service',
      name: `Education Insurance in ${city.city}, ${city.abbreviation}`,
      provider: { '@type': 'InsuranceAgency', name: 'ALKEME Insurance Services', url: 'https://alkemeins.com' },
      description: city.metaDescription,
      url: `https://alkemeins.com/education/cities/${city.slug}/`,
      serviceType: 'Educational Institution Insurance',
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', '@id': `https://alkemeins.com/education/cities/${city.slug}/`, name: 'ALKEME Insurance Services', url: 'https://alkemeins.com', telephone: '+18559255363', email: 'info@alkemeins.com', areaServed: { '@type': 'City', name: city.city, containedInPlace: { '@type': 'State', name: city.state } }, priceRange: '$$' }) }} />
