...
const coverages = [
  ...
  { title: 'Commercial Property', slug: 'commercial-property', desc: 'Protection for school buildings, equipment, technology, and educational materials against fire, weather, theft, and vandalism.' },
  ...
  { title: 'Cyber Liability', slug: 'cyber-liability', desc: 'Coverage for data breaches, ransomware, student record exposure, and FERPA violations in an increasingly digital education environment.' },
  { title: 'Commercial Auto', slug: 'commercial-auto', desc: 'Liability and physical damage coverage for school bus fleets, institutional vehicles, and student transportation operations.' },
