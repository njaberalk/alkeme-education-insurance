...
const LINK_MAP = [
  ...
  ['workers comp', '/coverage/workers-compensation/'],
  ['campus property', '/coverage/campus-property/'],
  ...
  ['student data privacy', '/coverage/student-data-privacy/'],
  ['student transportation', '/coverage/student-transportation/'],
  ...
  ['STEM programs', '/industries/stem-robotics-programs/'],
  ['robotics programs', '/industries/stem-robotics-programs/'],
  ['maker spaces', '/industries/stem-robotics-programs/'],
  ...
  // Resources
  ['FERPA', '/coverage/student-data-privacy/'],
