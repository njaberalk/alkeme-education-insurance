...
const coverageItems = [
  ...
  { label: 'Student Data Privacy', href: '/coverage/student-data-privacy/' },
  { label: 'Student Transportation', href: '/coverage/student-transportation/' },
  { label: 'Umbrella / Excess', href: '/coverage/umbrella-excess/' },
  { label: 'Student Accident', href: '/coverage/student-accident/' },
];
...
const resourceItems = [
  ...
  { label: 'School Insurance Cost', href: '/resources/school-insurance-cost-guide/' },
  { label: 'School Liability Guide', href: '/resources/school-liability-guide/' },
  { label: 'Abuse & Molestation Guide', href: '/resources/abuse-molestation-coverage-guide/' },
  { label: 'Title IX Compliance', href: '/resources/title-ix-compliance-guide/' },
  { label: 'Insurance Glossary', href: '/resources/education-insurance-glossary/' },
  { label: '— Insights —', href: null, divider: true },
  { label: 'Market Trends 2026', href: '/blog/education-insurance-trends-2026/' },
  { label: 'Cyber Threats Rising', href: '/blog/school-cyber-threats-rising/' },
  { label: 'Common Mistakes', href: '/blog/common-insurance-mistakes-schools/' },
];

const industryItems = [
  { label: 'K-12 School Districts', href: '/industries/k12-school-districts/' },
  { label: 'Charter Schools', href: '/industries/charter-schools/' },
  { label: 'Private Schools', href: '/industries/private-schools/' },
  { label: 'Colleges & Universities', href: '/industries/colleges-universities/' },
  { label: 'Preschools & Daycares', href: '/industries/preschools-daycares/' },
  { label: 'Trade & Vocational', href: '/industries/trade-vocational/' },
  { label: 'STEM & Robotics', href: '/industries/stem-robotics-programs/' },
  { label: 'Online Education', href: '/industries/online-education/' },
  { label: 'Special Education', href: '/industries/special-education/' },
  { label: 'After-School Programs', href: '/industries/after-school-programs/' },
];
...
export default function Header() {
  ...
  const isHome = pathname === '/education' || pathname === '/education/' || pathname === '/';
      ...
      >
        ...
        <div className="lg:hidden bg-stone overflow-hidden" aria-hidden="true" style={{ maxHeight: mobileOpen ? '90vh' : '0', transition: 'max-height 0.4s ease', borderTop: mobileOpen ? '1px solid #e3e3d8' : 'none' }}>
          <div className="px-6 py-6 space-y-1 max-h-[80vh] overflow-y-auto">
            ...
            <span className="block text-blue-dark uppercase tracking-[0.12em] font-bold pb-2 border-b border-ash mb-3 mt-6" style={{ fontSize: '0.65rem' }}>Institutions</span>
            ...
            <div className="border-t border-ash pt-4 mt-4 space-y-3">
              ...
              <Link href="/resources/school-insurance-cost-guide/" onClick={() => setMobileOpen(false)} className="block text-brand hover:text-blue-dark uppercase tracking-[0.12em] font-semibold py-2 no-underline" style={{ fontSize: '0.7rem' }}>School Insurance Cost</Link>
              <Link href="/resources/school-liability-guide/" onClick={() => setMobileOpen(false)} className="block text-brand hover:text-blue-dark uppercase tracking-[0.12em] font-semibold py-2 no-underline" style={{ fontSize: '0.7rem' }}>School Liability Guide</Link>
              <Link href="/blog/education-insurance-trends-2026/" onClick={() => setMobileOpen(false)} className="block text-brand hover:text-blue-dark uppercase tracking-[0.12em] font-semibold py-2 no-underline" style={{ fontSize: '0.7rem' }}>Market Trends 2026</Link>
