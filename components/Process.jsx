...
const steps = [
  { num: '01', title: 'Tell Us About Your Institution', desc: 'Share details about your school type, student population, facilities, and current coverage so we can understand your unique needs.' },
  { num: '02', title: 'Review Your Risks & Requirements', desc: 'Our specialists analyze your exposure areas, compliance requirements, and institutional objectives to identify optimal coverage strategies.' },
  ...
  { num: '04', title: 'Bind Coverage With Ongoing Support', desc: 'Once you approve, we bind your policies and remain your advocate through renewals, claims, and as your institution evolves.' },
];
